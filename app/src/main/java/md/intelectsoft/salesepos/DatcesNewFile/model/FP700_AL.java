...
public class FP700_AL extends FiscalDeviceV2 {
    ...
    public FP700_AL(InputStream in, OutputStream out) throws IOException, FiscalException, IllegalArgumentException {
        this(new TransportProtocolV2(in, out, 1250));
    }

    public FP700_AL(AbstractTransportProtocol protocol) throws IllegalArgumentException {
        super(protocol);
        this.printColumnsSupported = new String[]{"42", "48", "64"};
        this.MAX_PLU = 3000;
        this.maxNonFiscalText = 64;
        this.maxTextHeaderFooter = 64;
        this.capHasCutter = true;
        this.capFontSupprted = true;
