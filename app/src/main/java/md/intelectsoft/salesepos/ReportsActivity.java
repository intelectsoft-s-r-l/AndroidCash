                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ReportsActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (reportNummber[0] != -1) {
                                    Toast.makeText(ReportsActivity.this, "X report imprimat!", Toast.LENGTH_SHORT).show();
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ReportsActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (reportNumber[0] != -1) {
                                    Toast.makeText(ReportsActivity.this, "Z report a fost imrpimat!", Toast.LENGTH_SHORT).show();
