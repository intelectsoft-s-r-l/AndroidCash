...
public class Rfc2898DerivesBytes {
     ...
     */
    public Rfc2898DerivesBytes(byte[] password, byte[] salt, int iterations) throws NoSuchAlgorithmException, InvalidKeyException
    {
     ...
     */
    public Rfc2898DerivesBytes(String password, byte[] salt, int iterations) throws InvalidKeyException, NoSuchAlgorithmException,
     ...
     *             UTF-8 encoding is not supported.
     */
    public Rfc2898DerivesBytes(String password, byte[] salt) throws NoSuchAlgorithmException, InvalidKeyException,
            UnsupportedEncodingException
    {
