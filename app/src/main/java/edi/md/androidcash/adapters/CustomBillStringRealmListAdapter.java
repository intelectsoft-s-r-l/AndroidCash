...
public class CustomBillStringRealmListAdapter extends RealmBaseAdapter<BillString> implements ListAdapter {
    ...
    public CustomBillStringRealmListAdapter(@Nullable OrderedRealmCollection<BillString> data) {
        super(data);
    }
